          ...
          plans.map((plan: any, index: number) => (
            ...
            >
              <div>
                ...
                <button className='w-full text-black bg-transparent mt-4 border border-[#CAD0D9] hover:bg-[#6F42C1E5] hover:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center'>
                  Start for free
                </button>
                <ul className='my-6 space-y-2'>
                  {!isEmpty(plan?.PlanDescriptions) &&
                    plan?.PlanDescriptions.map((feature: any, idx: number) => (
