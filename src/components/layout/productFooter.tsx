...
const ProductFooter = () => {
  ...
  return (
    <footer className='w-full bg-white fixed bottom-0 xs:grid grid-cols-6 lg:hidden h-[50px] shadow-[0px_-2px_4px_0px_rgba(0,0,0,0.25)]'>
      <Link
        href='/overview'
      ...
      <Link
        href='/essays'
        className={`mobile-nav ${router.pathname == '/essays' ? 'active' : ''}`}
      >
        <EssayOutlined
          className='w-5'
